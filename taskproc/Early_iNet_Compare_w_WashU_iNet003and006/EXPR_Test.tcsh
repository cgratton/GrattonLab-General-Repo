...
# to execute via tcsh: 
#   tcsh -xef EXPR_Test.tcsh |& tee output.EXPR_Test.tcsh
# to execute via bash: 
#   tcsh -xef EXPR_Test.tcsh 2>&1 | tee output.EXPR_Test.tcsh
...
3dDeconvolve -input pb04.Mixed_All_Runs_Orig01_RUN.r01.scale+orig.HEAD pb04.Mixed_All_Runs_Orig01_RUN.r02.scale+orig.HEAD pb04.Mixed_All_Runs_Orig01_RUN.r03.scale+orig.HEAD pb04.Mixed_All_Runs_Orig01_RUN.r04.scale+orig.HEAD \
    ...
    -stim_times 7 stimuli_ses1/AbsCon_sustained.txt 'EXPR(0,104.4)1'               \
    ...
    -stim_times 13 stimuli_ses1/MR_sustained.txt 'EXPR(0,104.4)1'                  \
    ...
    -stim_times 19 stimuli_ses1/Rhyme_sustained.txt 'EXPR(0,104.4)1'               \
    -stim_label 19 Rhyme_sustained                                            \
    -stim_times 20 stimuli_ses1/Rhyme_yes_corr.txt 'TENT(0,17.6,16)'               \
    -stim_label 20 Rhyme_yes_corr                                             \
    -iresp 1 iresp_AbsCon_abs_corr.ses1expr                                      \
    -iresp 2 iresp_AbsCon_amb.ses1                                           \
    -iresp 3 iresp_AbsCon_con_corr.ses1expr                                      \
    -iresp 4 iresp_AbsCon_endcue.ses1expr                                        \
    -iresp 5 iresp_AbsCon_error.ses1expr                                         \
    -iresp 6 iresp_AbsCon_startcue.ses1expr                                      \
    -iresp 8 iresp_MR_endcue.ses1expr                                            \
    -iresp 9 iresp_MR_error.ses1expr                                             \
    -iresp 10 iresp_MR_mirror_corr.ses1expr                                      \
    -iresp 11 iresp_MR_same_corr.ses1expr                                        \
    -iresp 12 iresp_MR_startcue.ses1expr                                         \
    -iresp 14 iresp_Rhyme_amb.ses1expr                                           \
    -iresp 15 iresp_Rhyme_endcue.ses1expr                                        \
    -iresp 16 iresp_Rhyme_error.ses1expr                                         \
    -iresp 17 iresp_Rhyme_no_corr.ses1expr                                       \
    -iresp 18 iresp_Rhyme_startcue.ses1expr                                      \
    -iresp 20 iresp_Rhyme_yes_corr.ses1expr                                      \
    -num_glt 19                                                               \
    ...
    -float                                                                    \
    -jobs 4                                                                   \
    -fout -tout -x1D X.xmatses1expr.1D -xjpeg Xses1expr.jpg                                   \
    -fitts fitts.ses1expr                                                        \
    -errts errts.ses1expr                                                      \
    -bucket stats.ses1expr
