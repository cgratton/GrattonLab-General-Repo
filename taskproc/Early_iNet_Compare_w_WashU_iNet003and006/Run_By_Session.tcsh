...
# to execute via tcsh: 
#   tcsh -xef Run_By_Session.tcsh |& tee output.Run_By_Session.tcsh
# to execute via bash: 
#   tcsh -xef Run_By_Session.tcsh 2>&1 | tee output.Run_By_Session.tcsh

# ------------------------------
# run the regression analysis
3dDeconvolve -input pb04.Mixed_All_Runs_Orig_Together01_RUN.r01.scale+orig.HEAD pb04.Mixed_All_Runs_Orig_Together01_RUN.r02.scale+orig.HEAD pb04.Mixed_All_Runs_Orig_Together01_RUN.r03.scale+orig.HEAD pb04.Mixed_All_Runs_Orig_Together01_RUN.r04.scale+orig.HEAD \
    ...
    -iresp 1 iresp_AbsCon_abs_corr.ses1                                      \
    -iresp 2 iresp_AbsCon_amb.ses1                                           \
    -iresp 3 iresp_AbsCon_con_corr.ses1                                      \
    -iresp 4 iresp_AbsCon_endcue.ses1                                        \
    -iresp 5 iresp_AbsCon_error.ses1                                         \
    -iresp 6 iresp_AbsCon_startcue.ses1                                      \
    -iresp 8 iresp_MR_endcue.ses1                                            \
    -iresp 9 iresp_MR_error.ses1                                             \
    -iresp 10 iresp_MR_mirror_corr.ses1                                      \
    -iresp 11 iresp_MR_same_corr.ses1                                        \
    -iresp 12 iresp_MR_startcue.ses1                                         \
    -iresp 14 iresp_Rhyme_amb.ses1                                           \
    -iresp 15 iresp_Rhyme_endcue.ses1                                        \
    -iresp 16 iresp_Rhyme_error.ses1                                         \
    -iresp 17 iresp_Rhyme_no_corr.ses1                                       \
    -iresp 18 iresp_Rhyme_startcue.ses1                                      \
    -iresp 20 iresp_Rhyme_yes_corr.ses1                                      \
    -num_glt 19                                                               \
    ...
    -float                                                                    \
    -jobs 4                                                                   \
    -fout -tout -x1D X.xmatses1.1D -xjpeg Xses1.jpg                                   \
    -fitts fitts.ses1                                                        \
    -errts errts.ses1                                                      \
    -bucket stats.ses1
