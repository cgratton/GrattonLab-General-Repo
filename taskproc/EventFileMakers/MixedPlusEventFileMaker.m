...
mixed_runs=16;
%Get data%
pathtodata='/Users/derek.smith/Box/GrattonLab/AFNI_Test_Folder/iNetworksTestSub6/EventFiles/'
...
%Make path%
fixed='/Users/derek.smith/Box/GrattonLab/AFNI_Test_Folder/iNetworksTestSub6/scan_stimuli_folder/stimuli_';
...
%Make Tab Delim Row%
    ...
    if runindex==1;
    dlmwrite('Rhyme_amb.txt',row_Rhyme_amb,'delimiter','\t');
    dlmwrite('Rhyme_no_corr.txt',row_Rhyme_no_corr,'delimiter','\t');
    dlmwrite('Rhyme_error.txt',row_Rhyme_error,'delimiter','\t');
    dlmwrite('Rhyme_yes_corr.txt',row_Rhyme_yes_corr,'delimiter','\t');
    dlmwrite('Rhyme_startcue.txt',row_Rhyme_startcue,'delimiter','\t');
    dlmwrite('Rhyme_sustained.txt',row_Rhyme_sustained,'delimiter','\t');
    dlmwrite('Rhyme_endcue.txt',row_Rhyme_endcue,'delimiter','\t');
    dlmwrite('AbsCon_amb.txt',row_AbsCon_amb,'delimiter','\t');
    ...
    dlmwrite('AbsCon_sustained.txt',row_AbsCon_sustained,'delimiter','\t');
    ...
    dlmwrite('MR_startcue.txt',row_MR_startcue,'delimiter','\t');
    dlmwrite('MR_sustained.txt',row_MR_sustained,'delimiter','\t');
    dlmwrite('MR_endcue.txt',row_MR_endcue,'delimiter','\t');
    else
    dlmwrite('Rhyme_amb.txt',row_Rhyme_amb,'-append','delimiter','\t');
    dlmwrite('Rhyme_no_corr.txt',row_Rhyme_no_corr,'-append','delimiter','\t');
    dlmwrite('Rhyme_error.txt',row_Rhyme_error,'-append','delimiter','\t');
    dlmwrite('Rhyme_yes_corr.txt',row_Rhyme_yes_corr,'-append','delimiter','\t');
    dlmwrite('Rhyme_startcue.txt',row_Rhyme_startcue,'-append','delimiter','\t');
    dlmwrite('Rhyme_sustained.txt',row_Rhyme_sustained,'-append','delimiter','\t');
    dlmwrite('Rhyme_endcue.txt',row_Rhyme_endcue,'-append','delimiter','\t');
    dlmwrite('AbsCon_amb.txt',row_AbsCon_amb,'-append','delimiter','\t');
    ...
    dlmwrite('AbsCon_sustained.txt',row_AbsCon_sustained,'-append','delimiter','\t');
    ...
    dlmwrite('MR_startcue.txt',row_MR_startcue,'-append','delimiter','\t');
    dlmwrite('MR_sustained.txt',row_MR_sustained,'-append','delimiter','\t');
