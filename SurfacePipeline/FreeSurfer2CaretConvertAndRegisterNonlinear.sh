...
for Hemisphere in L R ; do
  ...
  $Caret5_Command -file-convert -format-convert XML_BASE64 "$AtlasSpaceFolder"/"$NativeFolder"/"$Subject"."$Hemisphere".ArealDistortion.native.shape.gii
  ...
  $Caret5_Command -file-convert -format-convert XML_BASE64 "$AtlasSpaceFolder"/"$NativeFolder"/"$Subject"."$Hemisphere".sulc.native.shape.gii
  ...
  #cp "$AtlasSpaceFolder"/"$NativeFolder"/"$Subject"."$Hemisphere".sulc.native.shape.gii "$T1wFolder"/"$NativeFolder"/"$Subject"."$Hemisphere".sulc.native.shape.gii #commented out GW
  ...
  $Caret5_Command -file-convert -format-convert XML_BASE64 "$AtlasSpaceFolder"/"$NativeFolder"/"$Subject"."$Hemisphere".thickness.native.shape.gii
  ...
  $Caret5_Command -file-convert -format-convert XML_BASE64 "$AtlasSpaceFolder"/"$NativeFolder"/"$Subject"."$Hemisphere".curvature.native.shape.gii
  ...
  $Caret5_Command -file-convert -format-convert XML_BASE64 "$AtlasSpaceFolder"/"$NativeFolder"/"$Subject"."$Hemisphere".aparc.native.label.gii
  ...
  for Surface in very_inflated midthickness white pial inflated sphere ; do
    ...
    $Caret5_Command -file-convert -sc -is CARET "$AtlasSpaceFolder"/"$NativeFolder"/"$Subject"."$Hemisphere"."$Surface".native.coord.gii "$AtlasSpaceFolder"/"$NativeFolder"/"$Subject"."$Hemisphere".native.topo.gii -os GS "$AtlasSpaceFolder"/"$NativeFolder"/"$Subject"."$Hemisphere"."$Surface".native.surf.gii
    $Caret5_Command -file-convert -format-convert XML_BASE64 "$AtlasSpaceFolder"/"$NativeFolder"/"$Subject"."$Hemisphere"."$Surface".native.surf.gii
  ...
  $Caret5_Command -file-convert -format-convert XML_BASE64 "$AtlasSpaceFolder"/"$NativeFolder"/"$Subject"."$Hemisphere".sphere.reg.reg_LR.native.surf.gii
  ...
  $Caret5_Command -deformation-map-apply "$AtlasSpaceFolder"/native2164k_fs_LR."$Hemisphere".deform_map METRIC_AVERAGE_TILE "$AtlasSpaceFolder"/"$NativeFolder"/"$Subject"."$Hemisphere".thickness.native.shape.gii "$AtlasSpaceFolder"/"$Subject"."$Hemisphere".thickness.164k_fs_LR.shape.gii
  cd $DIR
  ...
  $Caret5_Command -spec-file-add "$AtlasSpaceFolder"/"$Subject"."$Hemisphere".164k_fs_LR.c5.spec surface_shape_file "$AtlasSpaceFolder"/"$Subject"."$Hemisphere".thickness.164k_fs_LR.shape.gii
  $Caret5_Command -file-convert -format-convert XML_BASE64 "$AtlasSpaceFolder"/"$Subject"."$Hemisphere".sulc.164k_fs_LR.shape.gii
  $Caret5_Command -file-convert -format-convert XML_BASE64 "$AtlasSpaceFolder"/"$Subject"."$Hemisphere".thickness.164k_fs_LR.shape.gii
  $Caret7_Command -set-structure "$AtlasSpaceFolder"/"$Subject"."$Hemisphere".sulc.164k_fs_LR.shape.gii $Structure 
  $Caret7_Command -set-structure "$AtlasSpaceFolder"/"$Subject"."$Hemisphere".thickness.164k_fs_LR.shape.gii $Structure 
  ...
  $Caret7_Command -add-to-spec-file "$AtlasSpaceFolder"/"$Subject".164k_fs_LR.wb.spec $Structure "$AtlasSpaceFolder"/"$Subject"."$Hemisphere".thickness.164k_fs_LR.shape.gii
  ...
  cd $DIR
  $Caret5_Command -file-convert -format-convert XML_BASE64 "$AtlasSpaceFolder"/"$Subject"."$Hemisphere".ArealDistortion.164k_fs_LR.shape.gii
  ...
  $Caret5_Command -file-convert -format-convert XML_BASE64 "$AtlasSpaceFolder"/"$Subject"."$Hemisphere".aparc.164k_fs_LR.label.gii
  ...
  $Caret5_Command -file-convert -format-convert XML_BASE64 "$AtlasSpaceFolder"/"$Subject"."$Hemisphere".aparc.a2009s.164k_fs_LR.label.gii
  ...
  $Caret5_Command -file-convert -format-convert XML_BASE64 "$AtlasSpaceFolder"/"$Subject"."$Hemisphere".BA.164k_fs_LR.label.gii
  ...
  for Surface in very_inflated midthickness white pial inflated sphere ; do
    ...
    $Caret5_Command -file-convert -format-convert XML_BASE64 "$AtlasSpaceFolder"/"$Subject"."$Hemisphere"."$Surface".164k_fs_LR.surf.gii
...
for Hemisphere in L R ; do
  ...
  for Surface in very_inflated midthickness white pial inflated sphere ; do
    ...
    $Caret5_Command -file-convert -format-convert XML_BASE64 "$AtlasSpaceFolder"/fsaverage_LR"$DownSampleNameI"k/"$Subject"."$Hemisphere"."$Surface"."$DownSampleNameI"k_fs_LR.surf.gii
  ...
  $Caret5_Command -deformation-map-apply "$AtlasSpaceFolder"/fsaverage_LR"$DownSampleNameI"k/native2"$DownSampleNameI"k_fs_LR."$Hemisphere".deform_map METRIC_AVERAGE_TILE "$AtlasSpaceFolder"/"$NativeFolder"/"$Subject"."$Hemisphere".thickness.native.shape.gii "$AtlasSpaceFolder"/fsaverage_LR"$DownSampleNameI"k/"$Subject"."$Hemisphere".thickness."$DownSampleNameI"k_fs_LR.shape.gii
  cd $DIR
  $Caret5_Command -file-convert -format-convert XML_BASE64 "$AtlasSpaceFolder"/fsaverage_LR"$DownSampleNameI"k/"$Subject"."$Hemisphere".sulc."$DownSampleNameI"k_fs_LR.shape.gii
  $Caret5_Command -file-convert -format-convert XML_BASE64 "$AtlasSpaceFolder"/fsaverage_LR"$DownSampleNameI"k/"$Subject"."$Hemisphere".thickness."$DownSampleNameI"k_fs_LR.shape.gii
  ...
  $Caret7_Command -set-structure "$AtlasSpaceFolder"/fsaverage_LR"$DownSampleNameI"k/"$Subject"."$Hemisphere".thickness."$DownSampleNameI"k_fs_LR.shape.gii $Structure
  ...
  $Caret5_Command -spec-file-add "$AtlasSpaceFolder"/fsaverage_LR"$DownSampleNameI"k/"$Subject"."$Hemisphere"."$DownSampleNameI"k_fs_LR.c5.spec surface_shape_file "$AtlasSpaceFolder"/fsaverage_LR"$DownSampleNameI"k/"$Subject"."$Hemisphere".thickness."$DownSampleNameI"k_fs_LR.shape.gii
  ...
  $Caret7_Command -add-to-spec-file "$AtlasSpaceFolder"/fsaverage_LR"$DownSampleNameI"k/"$Subject"."$DownSampleNameI"k_fs_LR.wb.spec $Structure "$AtlasSpaceFolder"/fsaverage_LR"$DownSampleNameI"k/"$Subject"."$Hemisphere".thickness."$DownSampleNameI"k_fs_LR.shape.gii
  ...
  cd $DIR
  $Caret5_Command -file-convert -format-convert XML_BASE64 "$AtlasSpaceFolder"/fsaverage_LR"$DownSampleNameI"k/"$Subject"."$Hemisphere".aparc."$DownSampleNameI"k_fs_LR.label.gii
  ...
  cd $DIR
  $Caret5_Command -file-convert -format-convert XML_BASE64 "$AtlasSpaceFolder"/fsaverage_LR"$DownSampleNameI"k/"$Subject"."$Hemisphere".aparc.a2009s."$DownSampleNameI"k_fs_LR.label.gii
  ...
  cd $DIR
  $Caret5_Command -file-convert -format-convert XML_BASE64 "$AtlasSpaceFolder"/fsaverage_LR"$DownSampleNameI"k/"$Subject"."$Hemisphere".BA."$DownSampleNameI"k_fs_LR.label.gii
