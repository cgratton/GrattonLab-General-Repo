...
trialBreakdown = [(1/3), (1/3), (1/3)]; %[ast, diff, same] Original [(6/12), (5/12), (1/12)] or [.5 .4 .1]
stimTime=1;
...
%     WaitSecs(ITI);
    ...
    allData(itrial, :) = {trialWord, colorOrder(itrial), trialOrder(itrial), response, RT, acc, wordOrder(itrial)};
...
allData{1, 9} = startTime(1:3); %Date
allData{trials, 8} = endTime(4:6); %End time 
